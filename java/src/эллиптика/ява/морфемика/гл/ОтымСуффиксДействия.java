...
внеся эллиптика.ява.морфемика.всп.ОтыменнойСуффикс;

/**
 *
 * @автор Антон Александрович Астафьев {@буквально <anton@astafiev.me>} (Anton Astafiev)
 */
доступный абстрактный класс ОтымСуффиксДействия расширяет ОтыменнойСуффикс воплощает МорфемаДействия {
