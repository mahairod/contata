...
доступный класс MorphemDescr расширяет СущностьАХЯНаКлючеInteger воплощает Serializable {
	...
	доступный логическое цельСовместима(ЧастьРечи цель){
		...
		если (целевойТип == ЧастьРечи.тотже && (цель == исходныйТип || исходныйТип == ЧастьРечи.любой)){
			верни истина;
		}
		верни ложь;
	}

	доступный логическое исхдникСовместим(ЧастьРечи исходник){
		верни исходник == исходныйТип || исходник == ЧастьРечи.любой;
	}
	...
	доступный ЧастьРечи дайЦелевойТип() {
		верни целевойТип;
	}
