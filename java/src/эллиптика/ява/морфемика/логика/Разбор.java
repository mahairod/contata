...
верх:
	...
	личный статичный итоговый Object[][] СПИСОК_СОСТОЯНИЙ = {
		...
		{ИНФИНИТИВ,		ОСНОВА,			ложь,		0,		"в",		см(),			ничто}, // ть -> в
		{ИНФИНИТИВ,		ПРЕДОСНОВА,		ложь,		0,		"ениj",		см("с-д"),		ничто},	// ти -> ение
		{ОСНОВА,			ПРЕДОСНОВА,		ложь,		1,		"ниj",		см(),			ничто},	// ать -> ание
		{ПРЕДОСНОВА,		ПРЕДОСНОВА_ОВ,	истина,		1,		ничто,		см(),			ничто},	// овать -> ование
		{ОСНОВА,			ПРЕДОСНОВА_Я,	ложь,		1,		"ниj,тиj",	см(),			ничто},	// ять
		{ПРЕДОСНОВА_ОВ,	ПРЕДОСНОВА_ИР,	ложь,		0,		"яциj",		см("ц-к"),		ничто},	// ировать -> ация
		{ПРЕДОСНОВА_Я,	КОРЕНЬ,			ложь,		1,		"в",		см(),			ничто},	// ять -> в
		{ОСНОВА,			ПРЕДОСНОВА_И,	ложь,		0,		"ениj,к",	см(),			ничто},	// ить -> ение,ка
		// выход
	};
	...
	статичный {
		...
		состояния.клади(1667, ПРЕДОСНОВА_ОВ);
		состояния.клади(1194, ПРЕДОСНОВА_ИР);
	}

	статичный переч Состояние {
		ИНФИНИТИВ, ОСНОВА, ПРЕДОСНОВА, ПРЕДОСНОВА_И, ПРЕДОСНОВА_Я, ПРЕДОСНОВА_ОВ, ПРЕДОСНОВА_ИР, КОРЕНЬ, ГОТОВО, ОШИБКА
	}
