...
доступный класс Единица {
	...
	доступный тщетный смениФорму(Коллекция<Граммема> граммемы){
		ФормаСлова формаСлова = Morph.найдиФорму(омоним.дайЗначение(), омоним.дайЧастьРечи(), новый МножествоСвёрток<>(граммемы));
		форма = формаСлова.дайСлово().вНижнемРегистре();
