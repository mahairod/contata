...
доступный класс Подборщик {
	...
	Список<Список<ЗаписьМорфемы>> итог;
	...
	доступный Список<Список<ЗаписьМорфемы>> подбери(Строка искомое, ЧастьРечи частьРечи, ширцел граммемы){
	...
	доступный Список<Список<ЗаписьМорфемы>> подбери(Строка искомое, ЧастьРечи частьРечи, Граммема... граммемы){
	...
	личный Список<Список<ЗаписьМорфемы>> подбери_(Строка искомое, ЧастьРечи частьРечи, Строка основа){
		...
		для (Вариант в: вар){
			Список<ЗаписьМорфемы> списокМорфем = новый ПорядковыйСписок<>();
			обходМорфем(в, списокМорфем, итог);
		}
		верни итог;
	}

	тщетный обходМорфем(Вариант вариант, Список<ЗаписьМорфемы> списокМорфем, Список<Список<ЗаписьМорфемы>> списки) {
		списокМорфем.добавь(вариант.getMorphemDescr());
		если (вариант.getДети() == ничто){
			Список<ЗаписьМорфемы> морфемы = новый ПорядковыйСписок<>(списокМорфем);
...
//			верни путь.дай(об(sa));
	...
	доступный ТипизированныйЗапрос<ЗаписьМорфемы> поиск(Строка искомое){
		...
		Утверждение утверждение = ск.и(
				ск.равны(путь(корень, ЗаписьМорфемы_.тип), ТипМорфемы.СУФФИКС),
				ск.словно(путь(корень, ЗаписьМорфемы_.морфема), "%"+искомое+"%")
		);
		кз.где(утверждение);
