...
внеси java.io.File;
внеси java.io.UnsupportedEncodingException;
внеси java.util.Коллекция;
внеси java.util.Множество;
внеси java.util.HashSet;
внеси java.util.Список;
внеси статичный ru.aot.morph.ТипГраммемы.*;
...
*/
	...
	статичный{
		{
			Строка раб_катал = System.getProperty("JNIMorphAPI-rml-dir");
			РАБОЧИЙ_КАТАЛОГ = (раб_катал==ничто) ? ничто : новый File(раб_катал);

			Строка бин_катал = System.getProperty("JNIMorphAPI-jni-lib-dir");
