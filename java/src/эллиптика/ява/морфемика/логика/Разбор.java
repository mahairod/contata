...
верх:
	...
	личный статичный итоговый Object[][] СПИСОК_СОСТОЯНИЙ = {
		...
		{ИНФИНИТИВ,		ОСНОВА,			ложь,		0,		"в",		ничто,			ничто}, // ть -> в
		{ИНФИНИТИВ,		ПРЕДОСНОВА,		ложь,		0,		"ениj",		"с-д",			ничто},	// ти
		{ОСНОВА,			ПРЕДОСНОВА,		ложь,		1,		"ниj",		ничто,			ничто},	// ать
		{ОСНОВА,			ПРЕДОСНОВА_Я,	ложь,		1,		"ниj,тиj",	ничто,			ничто},	// ять
		{ПРЕДОСНОВА_Я,	КОРЕНЬ,			ложь,		1,		"в",		ничто,			ничто},	// ять -> в
		{ОСНОВА,			ПРЕДОСНОВА_И,	ложь,		0,		"ениj,к",	ничто,			ничто},	// ить
		// выход
	};
