...
верх:
	...
	личный статичный итоговый Object[][] СПИСОК_СОСТОЯНИЙ = {
		...
		{ОСНОВА,			ПРЕДОСНОВА_Е,	ложь,		0,		"∅",		см(),			ничто},	// е-ть -> ∅
	...
	статичный {
		...
		состояния.клади(1668, ПРЕДОСНОВА_Е);		// -е
	}

	статичный переч Состояние {
		ИНФИНИТИВ, ОСНОВА, ПРЕДОСНОВА, ПРЕДОСНОВА_А, ПРЕДОСНОВА_Е, ПРЕДОСНОВА_И, ПРЕДОСНОВА_И2, ПРЕДОСНОВА_Я, ПРЕДОСНОВА_ОВ, ПРЕДОСНОВА_ИР, КОРЕНЬ, ГОТОВО, ОШИБКА
	}
