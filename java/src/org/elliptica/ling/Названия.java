...
доступный сопряжение Названия {
	...
	статичный итоговый Строка[] одуш_ти_кратко = {
		"одуш", "неод",
	};
	...
	статичный итоговый Строка[][] краткие_имена = {
		{"нет названия"},
		числа_кратко,	падежи_кратко,	роды_кратко, времена, лица, одуш_ти_кратко, видыГлагола, переходности, залоги, наклонения, степениСравнения, разряды
	};
