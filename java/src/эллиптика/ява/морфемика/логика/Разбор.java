...
верх:
	...
	личный статичный итоговый Object[][] СПИСОК_СОСТОЯНИЙ = {
		...
		{ОСНОВА,			ПРЕДОСНОВА_Я,	ложь,		1,		"ниj,тиj",	см(),			ничто},	// я-ть -> я-ние, я-тие
	...
	статичный переч Состояние {
		ИНФИНИТИВ, ОСНОВА, ПРЕДОСНОВА, ПРЕДОСНОВА_А, ПРЕДОСНОВА_И, ПРЕДОСНОВА_Я, ПРЕДОСНОВА_ОВ, ПРЕДОСНОВА_ИР, КОРЕНЬ, ГОТОВО, ОШИБКА
	}
